...
import { Star, ImagePlus, Trash2, Images, Heart } from "lucide-react";
      ...
      <div className="min-h-screen">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-4">معرض الأنشطة 🎨</h1>
            <p className="text-muted-foreground text-lg">
              مجموعة ملهمة من الأنشطة العملية المناسبة للأطفال
            </p>
          </div>

          {/* Activities Gallery — Slider */}
          <section className="mt-6">
            <div className="flex items-end justify-between flex-wrap gap-4 mb-8">
              <div>
                ...
                <p className="text-muted-foreground mt-1">انتقل بين الشرائح يدويًا أو دعها تنتقل تلقائيًا</p>
              </div>
              {isAdmin && (
                    ...
                    {activities.map((a, idx) => {
                      ...
                      return (
                        <CarouselItem key={a.id} className="md:basis-1/2 lg:basis-1/3">
                          <article className="group relative rounded-3xl overflow-hidden border-4 border-card shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-card">
                            ...
                            <div
                              className={`pointer-events-none absolute inset-0 bg-gradient-to-tr ${tint} to-transparent opacity-0 group-hover:opacity-90 transition-opacity duration-500 mix-blend-multiply`}
                            />
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-5 md:p-6 transition-transform duration-500 group-hover:translate-y-[-4px]">
                              ...
                              {a.description && (
                                <p className="mt-2 text-sm md:text-base text-white/95 leading-relaxed max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 overflow-hidden transition-all duration-500">
                                  {a.description}
                                </p>
                              )}
                            </div>
